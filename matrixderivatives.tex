...
\end{equation}
In fact, if $S_4$ is the symmetric group of order four acting on the set of indices $\{i_1, i_2, i_3, i_4\}$, there is a larger subgroup of $S_4$ whose action produces a trivial change in $\mathcal{B}(i_1, i_2, i_3, i_4)$. Namely, the Klein four-group, a normal subgroup of $S_4$, which in terms of permutations reads:
\begin{equation}
...
\end{align}
This property can be exploited to gain some computational efficiency. One can introduce an equivalence relation
\begin{equation}
